package com.bkonate.springbootjwt.security.services;
...
import com.bkonate.springbootjwt.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${bkonate.app.jwtRefreshExpirationMs}")
